...
<div id="navbar">
	...
	<a id="logoutButton" onclick="logout()">Logout</a>
        ...
        <%-- <a id="logoutButton" href="response.jsp">Responses</a>--%>
        <a id="logoutButton" onclick="payment()">OL Payment</a>
     ...
     <div class="holemat">
        ...
        <div class ="col2">
            <div class="row3">
                ...
                <p>Best Quality product is provided by us and we can assure that there will not be any foul quantity provided </p>
            </div>
            <div class="row4">
                
                <a id="shoppingCart" onclick="Accept()">Accept</a>
